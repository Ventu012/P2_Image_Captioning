...
def get_loader(transform,
               ...
               num_workers=0,
               cocoapi_loc='../P2_Image_Captioning/data'):
    ...
    if mode == 'train':
        ...
        annotations_file = '../P2_Image_Captioning/data/annotations/captions_train2014.json'
    if mode == 'test':
        ...
        annotations_file = '../P2_Image_Captioning/data/annotations/image_info_test2014.json'
